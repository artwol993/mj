      ...
      <div className="about-container-1">
        ...
        >
          <p style={{ textIndent: "20px" }}>
            ...
            Ważna jest dla mnie autentyczność oraz uważność na siebie i drugiego
            człowieka, które pomagają budować pozytywną relację. Widzę głęboki
            sens stosowania filozofii Podejścia Skoncentrowanego na
            Rozwiązaniach, w którym to terapeuta wspiera Klienta w zmierzaniu do
            preferowanej przyszłości, do życia bez problemu.
          </p>
          <br></br>
          <p style={{ textIndent: "20px" }}>
        ...
        <div className="about-container-box">
          ...
          >
            ...
            <ul>
              ...
              <li>
                CTSR – Terapia Skoncentrowana na Rozwiązaniach – kurs podstawowy
                i zaawansowany
              </li>
        ...
        <div className="about-container-box">
          ...
          >
            ...
            <ul>
              ...
              <li>Konsultacje psychologiczne i terapia młodzieży od 16 r.ż.</li>
          ...
          >
            ...
            <ul>
              <li>
                Antydepresyjny Telefon Zaufania Młodych – psycholog / terapeuta
