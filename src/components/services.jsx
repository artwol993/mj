          ...
          >
            ...
            <div className="services-box-text">
              <p className="services-box-p">
                ...
                humanistycznego. Oznacza to, <br></br> że w centrum jej
                zainteresowania stoi człowiek, jego zasoby oraz relacja
                międzyludzka. Współczesna psychoterapia Gestalt zakłada, że{" "}
          ...
          >
            <div className="services-box-text">
              <p className="services-box-p">
                ...
                potrzeby <br></br> i pragnienia. Słowem, tak realizować siebie{" "}
                <br></br> w świecie, tak się z nim kontaktować, <br></br> aby
                nie cierpieć.
              </p>
            </div>
